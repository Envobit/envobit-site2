...
const engagementModels = [
  {
    ...
    description: 'Level up your performance with the support of our specialists.',
  },
  {
    title: 'Hire a dedicated team',
    description: 'Save time & in-house resources by delegating the project to a dedicated team.',
  },
  {
    title: 'Build your product from scratch',
    description: 'Design a product tailored to your needs and bring it to life.',
  },
  {
...
const Waveform = ({ hoveredModel }: { hoveredModel: number | null }) => {
  ...
  if (initialAmplitudes.current.length === 0) {
    for (let i = 0; i < numBars; i++) {
        ...
        const scale = 0.2 + 0.8 * barPosition; // Linear scale from 0.2 to 1.0
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            We adapt to your needs, ensuring a seamless and effective partnership.
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4"
          ...
          {engagementModels.map((model, index) => (
            <Card
              ...
              className={cn(
                'group cursor-pointer border-2 bg-card transition-all duration-300 border-transparent hover:border-destructive hover:shadow-lg hover:shadow-destructive/10'
              )}
            >
              <CardHeader>
